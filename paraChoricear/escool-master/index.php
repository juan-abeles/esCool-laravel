...
<html>
    <head>
        ...
        <title>EsCool - La solución escolar definitiva</title>
    </head>
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="row text-secondary">
                        <div class="col-md-4 col-sm-4 col-xs-12 text-center queesescool-elemento">
                            <img src="img/espacio-intercambio.png" alt="Espacio intercambio" width=80%/>
                         ...
                         <div class="col-md-4 col-sm-4 col-xs-12 text-center queesescool-elemento">
                            <img src="img/aula-virtual.png" alt="Aula virtual" width=80% />
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 text-center queesescool-elemento">
                            <img src="img/administracion-datos.png" alt="Administracion datos" width=80%/>
        ...
        <section id="clientes">
            <div class="container">
                ...
                <section class="row">
                    <article>
                        <a href="http://colegioandersen.org" target="_blank"><img class="d-block" src="img/andersen.png" alt="andersen"></a> 
                        </article>
                    <article>
                            <a href="http://stbrendans.esc.edu.ar" target="_blank"><img class="d-block" src="img/brendans.png" alt="brendans"></a> 
                    </article>
                    <article>
                            <a href="http://cmb.org.ar" target="_blank"><img class="d-block" src="img/cmb.png" alt="cmb"></a> 
                    </article>
                    <article>
                            <a href="http://colegioesclavas.edu.ar" target="_blank"><img class="d-block" src="img/esclavas.png" alt="esclavas"></a> 
                    </article>
                    <article>
                            <a href="http://colegiosanagustin.com.ar" target="_blank"><img class="d-block" src="img/sanagustin.png" alt="sanagustin"></a> 
                    </article>
                    <article>
                            <a href="http://smt.edu.ar" target="_blank"><img class="d-block" src="img/smt.png" alt="smt"> </a>
                    </article>
                </section>
            </div>
        </section>
